...
#define FLAG_RGB2YUV_SHIFT	19
#define FLAG_RGB2YUV_MASK	(1 << FLAG_RGB2YUV_SHIFT)
...
int rga_blit(rga_img_info_t *src, rga_img_info_t *dst, unsigned int flag);
int rga_copy(void *s, void *d, int w, int h);
